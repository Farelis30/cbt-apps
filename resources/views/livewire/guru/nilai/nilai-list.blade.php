                ...
                @forelse ($nilais as $index => $nilai)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 flex space-x-2">
                            <a href="{{ route('guru.nilai.detail', $nilai->id) }}" class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">
                                Detail
                            </a>
                            <a href="{{ route('guru.nilai.jawaban', $nilai->id) }}" class="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">
                                Jawaban
                            </a>
