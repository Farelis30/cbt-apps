<div>
    <form wire:submit.prevent="save">
        ...
        <div class="mb-4">
            ...
            <input wire:model="nama_mapel" type="text" id="nama_mapel" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
