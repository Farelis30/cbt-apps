<x-layouts.admin>
    ...
    <div id="importModal" class="fixed inset-0 bg-gray-900/50 hidden overflow-y-auto h-full w-full" x-data="{ open: false }">
            ...
            <div class="mt-3 text-center">
                ...
                <form action="{{ route('admin.siswa.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="items-center px-4 py-3">
                        <a href="{{ route('admin.siswa.template') }}" class="cursor-pointer text-xs text-blue-600 hover:underline">Download Template</a>
