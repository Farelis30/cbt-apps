<x-layouts.admin>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.nilai.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                Kembali
            </a>
        </div>
    </x-slot>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mt-8 flex justify-between">
            <a href="{{ route('admin.nilai.jawaban', $nilai->id) }}" class="px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600">
                Lihat Jawaban Siswa
            </a>
            <a href="{{ route('admin.nilai.index') }}" class="px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">
