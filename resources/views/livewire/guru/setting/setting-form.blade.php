<div>
    ...
    <div class="flex items-center mb-6">
        <div class="relative">
            ...
            @elseif($user->guruProfile && $user->guruProfile->image)
                <!-- Show saved profile image -->
                <img src="{{ asset('storage/' . $user->guruProfile->image) }}" class="w-20 h-20 rounded-full object-cover border-2 border-gray-300">
            @else
